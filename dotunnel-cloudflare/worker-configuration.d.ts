/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 27a86a1336d0e9279769a666f6ab88c2)
// Runtime types generated with workerd@1.20260124.0 2026-01-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "TunnelSession";
	}
	interface Env {
		BUCKET: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
		CONFIG: string;
		TUNNEL_SESSION: DurableObjectNamespace<import("./src/worker").TunnelSession>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONFIG">> {}
}
